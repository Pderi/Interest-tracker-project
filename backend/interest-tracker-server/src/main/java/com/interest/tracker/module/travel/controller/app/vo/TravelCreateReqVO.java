 ...
 */
@Schema(description = "创建旅游记录请求 VO")
@Data
public class TravelCreateReqVO {

    @Schema(description = "地点名称", requiredMode = REQUIRED, example = "北京")
    ...
    @Schema(description = "旅游状态：1-想去 2-计划中 3-已去", example = "1")
