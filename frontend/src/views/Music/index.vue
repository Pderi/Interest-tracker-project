        ...
        <div class="guide-modal glass-effect">
          <div class="guide-modal-header">
            <div>
              ...
              <h3 class="guide-modal-title">3 步搞定你的音乐清单</h3>
            </div>
...
const GUIDE_STORAGE_KEY = 'music_onboarding_seen'
const guideVisible = ref(false)
const guideAutoShown = ref(false)
const guideSteps = [
  {
    title: '添加第一条记录',
    description: '点击右上角"添加记录"，录入想听的专辑，支持上传封面与标签。',
    action: '添加记录',
  },
  {
    title: '用筛选快速定位',
    description: '状态筛选 + 关键词搜索，快速找到在听/已听，列表支持分页。',
    action: '筛选/搜索',
  },
  {
    title: '评分与评价',
    description: '在卡片上直接编辑、评分、标记状态，保持你的音乐清单实时更新。',
    action: '编辑/评分',
  },
]
