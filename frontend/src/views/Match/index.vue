        ...
        <template #guide>
          <div class="guide-inline-panel glass-effect">
            ...
            <div class="guide-inline-actions">
              ...
              <AnimatedButton size="small" variant="secondary" @click="handleAdd">
                直接添加
              </AnimatedButton>
            </div>
          </div>
        ...
        <div class="guide-modal glass-effect">
          <div class="guide-modal-header">
            <div>
              ...
              <h3 class="guide-modal-title">3 步搞定你的球赛清单</h3>
            </div>
...
const GUIDE_STORAGE_KEY = 'match_onboarding_seen'
const guideVisible = ref(false)
const guideAutoShown = ref(false)
const guideSteps = [
  {
    title: '添加第一场比赛',
    description: '点击右上角“添加记录”，填写对阵双方、时间、比分或赛程信息。',
    action: '添加记录',
  },
  {
    title: '筛选和查找',
    description: '用类型筛选（联赛/杯赛/友谊赛），快速定位想看的或已看过的比赛。',
    action: '筛选',
  },
  {
    title: '记录比分与评价',
    description: '为比赛录入比分、标签和评价，随时回顾观赛体验。',
    action: '比分/评价',
  },
]
