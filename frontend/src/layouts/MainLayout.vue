<template>
  <div class="main-layout h-screen flex flex-col overflow-hidden relative">
    ...
    <div class="flex flex-1 overflow-hidden relative" style="z-index: 10;">
      ...
      <!-- Main Content -->
      <main class="flex-1 overflow-y-auto pb-16 lg:pb-0 relative" style="z-index: 10; background: linear-gradient(135deg, rgba(26, 26, 46, 0.6) 0%, rgba(22, 33, 62, 0.6) 50%, rgba(15, 52, 96, 0.6) 100%);">
